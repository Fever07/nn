...
parse_file, parse_pred_file, get_model_path, to_abs, load_gray_image, load_color_image
...
for dataset in datasets:
    absp = dataset['absp']
    paths, labels = parse_file(to_abs(absp, test_file))
    labels = numpy.array(labels)
    probs = parse_pred_file(to_abs(absp, pred_test_file))
    a_probs = parse_attack_files(to_abs(absp, a_test_f),
    ...
    abs_ex_f = to_abs(absp, examples_folder)
